 ...
 */
class getCagetorieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CagetorieRepository' shared autowired service.
     *
     * @return \App\Repository\CagetorieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CagetorieRepository.php';

        return $container->privates['App\\Repository\\CagetorieRepository'] = new \App\Repository\CagetorieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
