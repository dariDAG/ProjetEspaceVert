...
class __TwigTemplate_02ac073c0d20f4da3b17eb8e854bfe528f6ea8188f5cdefccfbbfafffd67c532 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  116 => 16,  110 => 13,  106 => 12,  102 => 11,  94 => 8,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %} {{ product.name}} - L'Espace Vert en Ligne {% endblock %}

{% block content %}
    <div class=\"row\">
        <div class=\"col-md-5\"> 
            <img src=\"/upload/images/products/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\">
        </div>    
        <div class=\"col-md-7 my-auto \">    
            <h3> {{ product.name }} </h3>    
...
{% endblock %}
", "product/show.html.twig", "C:\\Users\\ridag\\OneDrive\\Bureau\\DOCS\\Back End\\symfony\\ProjetEspaceVert\\templates\\product\\show.html.twig");
    }
}
