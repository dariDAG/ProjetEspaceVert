...
class __TwigTemplate_b4df34c149596a98fdbb18ad4dd605526bf8bc0341c030c4b90072ca57280530 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <style>
        ...
        .customize-this-controller { align-items: center; border-top: 1px solid #e2e8f0; display: flex; margin-top: 32px; padding: 44px 12px 0; }
        .customize-this-controller svg { color: #94a3b8; height: 24px; margin-right: 6px; width: 24px; }
        pre {
            background: #f8fafc;
            border-radius: 6px;
        ...
        @media (min-width: 768px) {
            ...
            article p.success { font-size: 18px; }
            ...
            pre { margin: 10px 0; }
            .customize-this-controller { padding: 48px 0 0; }
        }
    </style>
...
<article>
    ...
    <p class=\"customize-this-controller\">
        <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"icon d-none d-md-inline-block\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
            <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z\" />
        </svg>

        This is the default EasyAdmin dashboard page. Customize it by editing this file:
    </p>

    <pre translate=\"no\" class=\"notranslate\">";
        // line 158
        echo twig_escape_filter($this->env, (isset($context["dashboard_controller_filepath"]) || array_key_exists("dashboard_controller_filepath", $context) ? $context["dashboard_controller_filepath"] : (function () { throw new RuntimeError('Variable "dashboard_controller_filepath" does not exist.', 158, $this->source); })()), "html", null, true);
        echo "</pre>
</article>
</body>
</html>
...
", "@EasyAdmin/welcome.html.twig", "C:\\Users\\ridag\\OneDrive\\Bureau\\DOCS\\Back End\\symfony\\ProjetEspaceVert\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\welcome.html.twig");
    }
}
